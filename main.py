...
def ask():
    ...
    input = "Retrive Invoice party name, invoice date, invoice number, invoice amount in json format, with keys as  vendor,date,number,amount"
    print('Retrieving answer...')
    answer = get_rag_response(input, qa_chain)
